...
$CFG->dbtype    = 'mysqli';                  // docker-compose: mysql
$CFG->dblibrary = 'native';                 // 'native' only at the moment
$CFG->dbhost    = 'db';                     // docker-compose 서비스명
$CFG->dbname    = 'moodle';                 // docker-compose 환경변수
$CFG->dbuser    = 'root';                   // root 계정으로 변경
$CFG->dbpass    = 'root';                   // root 패스워드로 변경
...
// Handle ngrok reverse proxy - convert to HTTPS
...
if (strpos($host, 'mz-lms.ngrok.app') !== false) {
    // ngrok access - always use HTTPS
    $CFG->wwwroot = 'https://mz-lms.ngrok.app';
    $CFG->sslproxy = true;  // Tell Moodle to generate HTTPS links
